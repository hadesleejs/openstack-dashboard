...
def volume_snapshot_rollback(request, volume, snapshot_id, force):
    #patch by longxing: To Rollback a snapshot based on volume
    return cinderclient(request).volumes.rollback(volume, snapshot_id, force)
