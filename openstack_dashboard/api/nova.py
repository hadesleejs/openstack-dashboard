...
def server_rollback(request,instance,volume_id,snapshot_id,force):
    #Added by longxing:Rollback the server disks from snapshots
    novaclient(request).servers.volume_rollback(instance,volume_id,snapshot_id,force)
