...
urlpatterns = patterns(
    ...
    url(r'^(?P<instance_id>[^/]+)/\?tab=instance_details__snapshots_tab/$',
        views.DetailView.as_view(), name='snapshots_tab'),
    url(r'^(?P<instance_id>[^/]+)/$',
    ...
    url(INSTANCES % 'create_snapshot_advanced/$',
        views.CreateSnapshotAdvancedView.as_view(),
        name='create_snapshot_advanced'),
    url(INSTANCES % 'show_snapshot_advanced/$',
        views.IndexView.as_view(), name='show_snapshot_advanced'),
    url(r'^(?P<instance_id>[^/]+)/rollback_snapshot_advanced_act/(?P<volume_id>[^/]+)/(?P<snapshot_id>[^/]+)/$',
        views.RollbackSnapshotAdvancedActView.as_view(),
        name='rollback_snapshot_advanced_act'),
)
